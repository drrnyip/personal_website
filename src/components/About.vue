<template>
    <div id="about" class="py-12 bg-gray-100 dark:bg-gray-800">
        ...
        <div class="flex flex-col md:flex-row my-10">
            ...
            <div class="m-auto md:mt-[35%] md:mr-8 h-48 w-48 ring-2 ring-red-700 dark:ring-yellow-500 rounded-full bg-red-500">
            ...
            <aos-vue animation="fade-up" :once="true" placement="center-bottom" duration="750">
                <div
                    ...
                    <br />
                    <p>
                        I've been building web applications since 2015, working for <a
                            href="https://www.checkmate.digital" class="underline" target="_blank">smaller startups</a>
                        to <a class="underline" href="https://www.nyse.com/index" target="_blank">large
                            corporations</a>. My primary interest
                        lies in
                        creating engaging and memorable digital experiences for people.
                    </p>
                    <br />
                    <p>My interests are music, traveling, reading & RPG games. When not in front of a computer, I can
